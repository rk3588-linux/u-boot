...
struct rk3588_pmu1_grf {
    ...
    uint32_t rst_sts;
    uint32_t rst_clr;
    uint32_t reserved5[82];
    uint32_t sd_detect_con;
    uint32_t reserved6[3];
    uint32_t sd_detect_sts;
    uint32_t reserved7[3];
    uint32_t sd_detect_clr;
    uint32_t reserved8[3];
    uint32_t sd_detect_cnt;
};
check_member(rk3588_pmu1_grf, sd_detect_cnt, 0x03b0);
